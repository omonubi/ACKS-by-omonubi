...
| Property | Description |
| --- | --- |
| *roll_initiative* | When the button is clicked, accepts a modifier and then applies it to a 1d6 roll, modified by *mod_initiative* field value if any. The result is output in the Roll20 chat window and sent to the turn tracker. Use the modifier field to account for two-handed weapon penalties and/or other necessary modifications to the roll, as needed. |
